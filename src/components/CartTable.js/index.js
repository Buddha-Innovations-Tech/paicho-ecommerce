      ...
      <div className="carttable">
        <div className="d-flex justify-content-between align-items-center">
          ...
          <div className="carttable__heading d-flex align-items-center">
            ...
            <span className="carttable__heading--selectitem"><u>Clear Cart</u></span>
          </div>
        </div>
        <div className="carttable__maintable">
              ...
              {mainTableData.map((data, index) => {
                return (
                  <tr>
                    ...
                    <td>{data.unitcost}</td>
                    {window.location.href.includes('shoppingcart') &&<td >Rs 500</td>}
                    {window.location.href.includes('whishlist') &&<td  > <button className="carttable__maintable--crossicon">Add to Cart</button> </td>}
                    {/* <td > <button className="carttable__maintable--crossicon">{icon}</button> </td> */}
                    <td className="carttable__maintable--deleteicon">{icon} </td>
                  </tr>
                );
              })}
            </tbody>
          ...
          <div className="carttable__pagination">
              <Link to=""><CgChevronDoubleLeft className="me-2"/>Continue Shopping</Link>
          </div>
      </div>
    </>
  );
